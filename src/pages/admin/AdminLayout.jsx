...
import { LayoutDashboard, Package, LogOut, Ticket, ShoppingBag, Tag, Menu, X, Users, FileText } from 'lucide-react';
import './Admin.css';
    ...
    <div className="admin-layout">
      ...
      <aside className={`admin-sidebar ${isMobileMenuOpen ? 'open' : ''}`}>
        ...
        <nav style={{ flexGrow: 1, padding: '20px 0', overflowY: 'auto' }}>
          ...
          <NavLink onClick={closeMobileMenu} to="/admin/categories" className={({isActive}) => isActive ? "admin-nav-item active" : "admin-nav-item"}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 22h14a2 2 0 0 0 2-2V7.5L14.5 2H6a2 2 0 0 0-2 2v4"></path><polyline points="14 2 14 8 20 8"></polyline><path d="M2 15h10"></path><path d="M5 12l-3 3 3 3"></path></svg> Categories
          </NavLink>
          <NavLink onClick={closeMobileMenu} to="/admin/orders" className={({isActive}) => isActive ? "admin-nav-item active" : "admin-nav-item"}>
            <ShoppingBag size={20} /> Orders
          </NavLink>
          <NavLink onClick={closeMobileMenu} to="/admin/returns" className={({isActive}) => isActive ? "admin-nav-item active" : "admin-nav-item"}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> Returns
          </NavLink>
          ...
          <NavLink onClick={closeMobileMenu} to="/admin/pages" className={({isActive}) => isActive ? "admin-nav-item active" : "admin-nav-item"}>
            <FileText size={20} /> Policies & Pages
          </NavLink>
          ...
          <NavLink onClick={closeMobileMenu} to="/admin/carts" className={({isActive}) => isActive ? "admin-nav-item active" : "admin-nav-item"}>
            <ShoppingBag size={20} /> Carts
          </NavLink>
