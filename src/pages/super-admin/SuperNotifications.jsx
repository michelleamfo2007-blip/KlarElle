            ...
            <div style={{ background: '#fff', borderRadius: '8px', border: '1px solid #e5e7eb', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '0 24px' }}>
                {lowStockProducts.map((product, index) => (
                  <div key={product.id} style={{ display: 'flex', flexWrap: 'wrap', padding: '16px 0', borderBottom: index < lowStockProducts.length - 1 ? '1px solid #f3f4f6' : 'none', justifyContent: 'space-between', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ background: '#fff', borderRadius: '8px', border: '1px solid #e5e7eb', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '0 24px' }}>
                {urgentTickets.map((ticket, index) => (
                  <div key={ticket.id} style={{ display: 'flex', flexWrap: 'wrap', padding: '16px 0', borderBottom: index < urgentTickets.length - 1 ? '1px solid #f3f4f6' : 'none', justifyContent: 'space-between', alignItems: 'center', gap: '12px' }}>
                    <div>
            ...
            <div style={{ background: '#fff', borderRadius: '8px', border: '1px solid #e5e7eb', overflow: 'hidden' }}>
              ...
              <div style={{ padding: '0 24px' }}>
                {pendingWaitlist.slice(0, 5).map((user, index) => (
                  <div key={user.id} style={{ display: 'flex', flexWrap: 'wrap', padding: '16px 0', borderBottom: index < Math.min(pendingWaitlist.length, 5) - 1 ? '1px solid #f3f4f6' : 'none', justifyContent: 'space-between', alignItems: 'center', gap: '12px' }}>
                    <div>
