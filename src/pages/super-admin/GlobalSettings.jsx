...
import { Save, Mail, Truck, Shield, DollarSign, Share2 } from 'lucide-react';
...
function GlobalSettings() {
  const [settings, setSettings] = useState({
    ...
    instagramUrl: 'https://www.instagram.com/klarelle.store',
    tiktokUrl: 'https://www.tiktok.com/@klarelle_store',
    facebookUrl: ''
  });
  ...
  if (isLoading) {
    return <div style={{ padding: '40px', textAlign: 'center', color: '#6b7280' }}>Loading settings...</div>;
  }

  const fieldStyle = { width: '100%', padding: '12px 16px', border: '1px solid #e5e7eb', borderRadius: '8px', fontSize: '15px', outline: 'none', boxSizing: 'border-box' };
  ...
  return (
    <div style={{ maxWidth: '800px', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: '#6b7280', margin: 0, fontSize: '15px' }}>Configure shipping, contact, and store status.</p>
      </div>
      ...
      <div style={{ background: '#fff', borderRadius: '16px', border: '1px solid #eaeaea', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.03)' }}>
        ...
        <div style={{ padding: '32px', borderBottom: '1px solid #eaeaea' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: '500', margin: 0, fontFamily: 'Playfair Display, serif', letterSpacing: '0.5px' }}>SHIPPING</h2>
          </div>
          <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>Free U.S. shipping over ($)</label>
          <input
            type="number"
        ...
        <div style={{ padding: '32px', borderBottom: '1px solid #eaeaea' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '12px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: '500', margin: 0, fontFamily: 'Playfair Display, serif', letterSpacing: '0.5px' }}>SALES TAX</h2>
          </div>
          <p style={{ margin: 0, fontSize: '14px', color: '#374151', lineHeight: 1.5 }}>
            No rate to type. Checkout pulls the current tax from the customer’s shipping address through Stripe Tax. Turn Stripe Tax on in the Stripe Dashboard.
          </p>
        </div>
        ...
        <div style={{ padding: '32px', borderBottom: '1px solid #eaeaea' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: '500', margin: 0, fontFamily: 'Playfair Display, serif', letterSpacing: '0.5px' }}>CONTACT</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#444', marginBottom: '10px' }}>Support Email</label>
              <input type="email" name="supportEmail" value={settings.supportEmail} onChange={handleChange} style={fieldStyle} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#444', marginBottom: '10px' }}>Support Phone</label>
              <input type="text" name="supportPhone" value={settings.supportPhone} onChange={handleChange} style={fieldStyle} />
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '32px', borderBottom: '1px solid #eaeaea' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
            ...
            <h2 style={{ fontSize: '20px', fontWeight: '500', margin: 0, fontFamily: 'Playfair Display, serif', letterSpacing: '0.5px' }}>SOCIAL</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>Instagram URL</label>
              <input type="url" name="instagramUrl" value={settings.instagramUrl} onChange={handleChange} style={fieldStyle} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>TikTok URL</label>
              <input type="url" name="tiktokUrl" value={settings.tiktokUrl} onChange={handleChange} style={fieldStyle} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: '500', color: '#374151', marginBottom: '8px' }}>Facebook URL</label>
              <input type="url" name="facebookUrl" value={settings.facebookUrl} onChange={handleChange} style={fieldStyle} />
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '32px', background: '#fef2f2' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', background: '#fff', border: '1px solid #fecaca', borderRadius: '8px' }}>
            <div>
              ...
              <p style={{ fontSize: '13px', color: '#6b7280', margin: 0 }}>Temporarily disable the storefront during updates.</p>
            </div>
