      ...
      <div className="container" style={{ padding: '40px 20px' }}>
        ...
        <div className="product-layout">
          <style>{`
            ...
            .main-image-wrap { background: #fff; position: relative; display: flex; align-items: center; justify-content: center; overflow: hidden; flex: 0 0 100%; scroll-snap-align: start; max-height: 65vh; }
