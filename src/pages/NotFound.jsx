...
function NotFound() {
  return (
    <>
      <SEO title="Page not found" description="This KlarElle page could not be found." />
      <div style={{ minHeight: '70vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 24px', textAlign: 'center', background: '#FAF9F6' }}>
        <div style={{ maxWidth: '520px' }}>
          <p style={{ letterSpacing: '3px', textTransform: 'uppercase', fontSize: '12px', color: '#BCA38F', marginBottom: '12px' }}>Klarélle</p>
